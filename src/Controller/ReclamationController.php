...
use App\Form\SearchComplaintType;
...
public function addReclamation(Request $request, ManagerRegistry $managerRegistry, ReclamationRepository $reclamationRepository,UserRepository $userRepository,TranslatorInterface $translator): Response
{
    $user=$userRepository->find(2);
    $em = $managerRegistry->getManager();
    $reclamation = new Reclamation();
    $message = $translator->trans('complaint added');    
    $form = $this->createForm(ReclamationsType::class, $reclamation);
        ...
        $em->flush();
        $this->addFlash('successC', $message);
    ...
    public function editReclamation(Request $request, ManagerRegistry $manager, ReclamationRepository $reclamationRepository, $id,TranslatorInterface $translator): Response
    {
        $em = $manager->getManager();
        $reclamation  = $reclamationRepository->find($id);
        $message = $translator->trans('complaint edited');
        $form = $this->createForm(ReclamationsType::class, $reclamation);
        $form->handleRequest($request);
    ...
    public function deleteReclamation (Request $request, ManagerRegistry $manager, $id, ReclamationRepository $reclamationRepository,TranslatorInterface $translator ): Response
    {
        $em = $manager->getManager();
        $message = $translator->trans('complaint deleted');
        $reclamation = $reclamationRepository->find($id);
        if (!$reclamation) {
    ...
    {
        $reclamation= new Reclamation();
        $form = $this->createForm(SearchComplaintType::class, $reclamation);
