 ...
 * @ORM\JoinTable(name="evenements_sponsors",
 *      joinColumns={@ORM\JoinColumn(name="evenements_id", referencedColumnName="idevenement")},
 *      inverseJoinColumns={@ORM\JoinColumn(name="sponsor_id", referencedColumnName="idsponsor")}
 * )
 */
