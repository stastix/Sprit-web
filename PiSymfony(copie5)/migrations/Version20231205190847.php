 ...
 */
final class Version20231205190847 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE sponsor (idsponsor INT AUTO_INCREMENT NOT NULL, NomSponsor VARCHAR(255) NOT NULL, Secteurdactivite VARCHAR(255) NOT NULL, adresseSponsor VARCHAR(255) NOT NULL, numtelSponsor INT NOT NULL, emailSponsor VARCHAR(255) NOT NULL, duree VARCHAR(255) DEFAULT NULL, PRIMARY KEY(idsponsor)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
